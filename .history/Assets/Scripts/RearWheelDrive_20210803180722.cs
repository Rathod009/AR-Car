...
using UnityEngine;
using UnityStandarAssets.CrossPlateformInput;
...
public class RearWheelDrive : MonoBehaviour
{
    ...
    void Update()
    {
     float angle = maxAngle * CrossPlateformInputManager.GetAxis("Horizontal");
     float torque = maxTorque * CrossPlateformInputManager.GetAxis("Vertical");
